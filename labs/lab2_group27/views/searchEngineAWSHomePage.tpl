...
function logOutGoogle(){
    ...
    document.location.href = "https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=http://ec2-34-234-38-53.compute-1.amazonaws.com/logout";
}
</script>
...
<!-- 	<form action = "/logout" id = "logout" method="GET" style="padding-right: 20px" onclick = "logOutGoogle()">
